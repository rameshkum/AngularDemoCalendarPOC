...
/*	$http.get('http://rameshkum:8081/api/allevents').
        then(function(response) {
            $scope.eventsData = response.data;			
			//console.log(JSON.stringify($scope.events));
			
			var eventsArray = $scope.eventsData;
...
*/
/*
 function createRandomEvents(eventsArray) {
	 console.log("create"+eventsArray);
...
/*	for (var i=0; i<greeting.length; i++) {
          ...
          var nshift = {
            title : greeting[i].employee,
            start : new Date(greeting[i].start),
            end : new Date(greeting[i].end),
            allDay: false
          }

          eventsArray.push(nshift);
  }
